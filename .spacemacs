...
(defun dotspacemacs/user-config ()
  (setq org-capture-templates
        '(("S" "Sprint" entry (file+headline "~/org/sprints.org" "Sprint")(file "~/org/templates/sprint.org") :empty-lines-before 1)
